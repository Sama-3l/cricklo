...
void _tournamentDependencies() {
  ...
  sl.registerLazySingleton<CreateGroupTableUsecase>(
    () => CreateGroupTableUsecase(sl<TournamentRepo>()),
  );
  sl.registerLazySingleton<RemoveTeamFromGroupUsecase>(
    () => RemoveTeamFromGroupUsecase(sl<TournamentRepo>()),
  );
  sl.registerLazySingleton<ModeratorUpdateMatchUsecase>(
    () => ModeratorUpdateMatchUsecase(sl<TournamentRepo>()),
  );
  //cubits
  ...
  sl.registerFactory<TournamentCubit>(
    () => TournamentCubit(
      ...
      sl<FollowUsecase>(),
      sl<UnFollowUsecase>(),
      sl<CreateGroupTableUsecase>(),
      sl<RemoveTeamFromGroupUsecase>(),
      sl<ModeratorUpdateMatchUsecase>(),
    ),
  );
