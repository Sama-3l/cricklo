...
class _CreateTournamentState extends State<CreateTournament> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => sl<CreateTournamentCubit>(),
      child: BlocBuilder<CreateTournamentCubit, CreateTournamentState>(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        DropdownButtonFormField<TournamentType>(
                          ...
                          decoration: InputDecoration(
                            labelText: _tournamentType == null
                                ? "Tournament Type"
                                : "",
                            filled: true,
                            labelStyle: TextStyles.poppinsMedium.copyWith(
                          ...
                          validator: (val) =>
                              val == null ? "Select a tournament type" : null,
                        ),
                      ],
                    ),
                  ),
